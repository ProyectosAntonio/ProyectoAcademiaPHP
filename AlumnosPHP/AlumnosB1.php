  ...
  <div class="personal-area">
    <nav class="menu-personal-area">
      <ul>
        ...
        <?php $dir1 = "../archivosB1/ComprensiónAuditiva";
        if($folder1 = opendir($dir1)){
          while ($archivo1 = readdir($folder1)) {
            if($archivo1 != "." && $archivo1 != ".."){
            echo "-<a href='/ProyectoFinal/archivosB1/ComprensiónAuditiva/$archivo1'>".$archivo1."</a><br><br>";
           }
          }
        } ?>
        <?php $dir2 = "../archivosB1/ComprensiónLectora";
        if($folder2 = opendir($dir2)){
          while ($archivo2 = readdir($folder2)) {
            if($archivo2 != "." && $archivo2 != ".."){
            echo "-<a href='/ProyectoFinal/archivosB1/ComprensiónLectora/$archivo2'>".$archivo2."</a><br><br>";
           }
          }
        } ?>
        <?php $dir3 = "../archivosB1/ProduccionEscrita";
        if($folder3 = opendir($dir3)){
          while ($archivo3 = readdir($folder3)) {
            if($archivo3 != "." && $archivo3 != ".."){
            echo "-<a href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo3'>".$archivo3."</a><br><br>";
           }
          }
        } ?>
        <?php $dir4 = "../archivosB1/ProduccionOral";
        if($folder4 = opendir($dir4)){
          while ($archivo4 = readdir($folder4)) {
            if($archivo4 != "." && $archivo4 != ".."){
            echo "-<a href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo4'>".$archivo4."</a><br>";
           }
          }
        } ?>
    ...
    <div class="tittle-main-Courses"><h2>Nivel: <?php echo $fila['Curso']; ?></h2></div>
      <div class="A2-content-courses">
        ...
        if($folder1 = opendir($dir1)){
          while ($archivo1 = readdir($folder1)) {
            if($archivo1 != "." && $archivo1 != ".."){
            echo "<a style='display:block; margin-top: 10px; margin-left: 5px;' href='/ProyectoFinal/archivosB1/ComprensiónAuditiva/$archivo1'>"."-".$archivo1."</a><br>";
           }
          }
        } ?>
        </div>
        ...
        if($folder2 = opendir($dir2)){
          while ($archivo2 = readdir($folder2)) {
            if($archivo2 != "." && $archivo2 != ".."){
            echo "<a style='display:block; margin-top: 10px; margin-left: 5px;' href='/ProyectoFinal/archivosB1/ComprensiónLectora/$archivo2'>"."-".$archivo2."</a><br>";
           }
          }
        } ?>
        </div>
        ...
        if($folder3 = opendir($dir3)){
          while ($archivo3 = readdir($folder3)) {
            if($archivo3 != "." && $archivo3 != ".."){
            echo "<a style='display:block; margin-top: 10px; margin-left: 5px;' href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo3'>"."-".$archivo3."</a><br>";
           }
          }
        } ?>
        </div>
        ...
        if($folder4 = opendir($dir4)){
          while ($archivo4 = readdir($folder4)) {
            if($archivo4 != "." && $archivo4 != ".."){
            echo "<a style='display:block; margin-top: 10px; margin-left: 5px;' href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo4'>"."-".$archivo4."</a><br>";
           }
          }
        } ?>
      </div>
