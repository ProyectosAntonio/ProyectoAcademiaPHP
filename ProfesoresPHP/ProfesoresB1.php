  ...
  <body>
   ...
   <div class="main-contain-body">
     ...
     <div class="main-Courses">
       ...
       <div class="tittle-main-Courses"><h2>Nivel: B1</h2></div>
         <div class="A2-content-courses">
           <div class="file-content">
           <h3>COMPRENSIÓN AUDITIVA</h3>
           <?php $dir1 = "C:/xampp/htdocs/ProyectoFinal/archivosB1/ComprensiónAuditiva";
           if($folder1 = opendir($dir1)){
             while ($archivo1 = readdir($folder1)) {
               if($archivo1 != "." && $archivo1 != ".."){
               echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ComprensiónAuditiva/$archivo1'>".$archivo1."</a> ..........&nbsp&nbsp<a href='deleteFileB1.php?item=../archivosB1/ComprensiónAuditiva/$archivo1'><img  src='/ProyectoFinal/images/papelera.png' class='paper-icon' alt='Icono de papelera'></a><br>";
              }
             }
           } ?>
         </div>
         <div class="file-content">
           ...
           <?php $dir2 = "C:/xampp/htdocs/ProyectoFinal/archivosB1/ComprensiónLectora";
           if($folder2 = opendir($dir2)){
             while ($archivo2 = readdir($folder2)) {
               if($archivo2 != "." && $archivo2 != ".."){
               echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ComprensiónLectora/$archivo2'>".$archivo2."</a> ..........&nbsp&nbsp<a href='deleteFileB1.php?item=../archivosB1/ComprensiónLectora/$archivo2'><img  src='/ProyectoFinal/images/papelera.png' class='paper-icon' alt='Icono de papelera'></a><br>";
              }
             }
           } ?>
          </div>
          <div class="file-content">
           ...
           <?php $dir3 = "C:/xampp/htdocs/ProyectoFinal/archivosB1/ProduccionEscrita";
           if($folder3 = opendir($dir3)){
             while ($archivo3 = readdir($folder3)) {
               if($archivo3 != "." && $archivo3 != ".."){
               echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo3'>".$archivo3."</a> ..........&nbsp&nbsp<a href='deleteFileB1.php?item=../archivosB1/ProduccionEscrita/$archivo3'><img  src='/ProyectoFinal/images/papelera.png' class='paper-icon' alt='Icono de papelera'></a><br>";
              }
             }
           } ?>
          </div>
          <div class="file-content">
           ...
           <?php $dir4 = "C:/xampp/htdocs/ProyectoFinal/archivosB1/ProduccionOral";
           if($folder4 = opendir($dir4)){
             while ($archivo4 = readdir($folder4)) {
               if($archivo4 != "." && $archivo4 != ".."){
               echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo4'>".$archivo4."</a> ..........&nbsp&nbsp<a href='deleteFileB1.php?item=../archivosB1/ProduccionOral/$archivo4'><img  src='/ProyectoFinal/images/papelera.png' class='paper-icon' alt='Icono de papelera'></a><br>";
              }
             }
           } ?>
           <?php
           ...
           if (isset($_POST['upload-button'])) {
             ...
             if (in_array($extension, $formats)) {
               if($skills == "Comprensión-auditiva"){
                 if (move_uploaded_file($TMPname_file, "../archivosB1/ComprensiónAuditiva/$name_file")) {
                   $archivosubido = "Archivo subido correctamente";
                 }else{
                   $error_archivo = "Error al subir archivo";
                 }
               }elseif($skills == "Comprensión-lectora"){
                 if (move_uploaded_file($TMPname_file, "../archivosB1/ComprensiónLectora/$name_file")) {
                   $archivosubido = "Archivo subido correctamente";
                 }else{
                   $error_archivo = "Error al subir archivo";
                 }
               }elseif($skills == "Producción-escrita"){
                 if (move_uploaded_file($TMPname_file, "../archivosB1/ProduccionEscrita/$name_file")) {
                   $archivosubido = "Archivo subido correctamente";
                 }else{
                   $error_archivo = "Error al subir archivo";
                 }
               }elseif($skills == "Producción-oral"){
                 if (move_uploaded_file($TMPname_file, "../archivosB1/ProduccionOral/$name_file")) {
                   $archivosubido = "Archivo subido correctamente";
                 }else{
                   $error_archivo = "Error al subir archivo";
                 }
